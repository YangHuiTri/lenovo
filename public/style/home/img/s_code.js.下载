...
var s_account = "lenovochinanewshop,lenovochina-prd"
...
var monitor_title = "Shop";

function monitor_setdefaultprop() {
    s.pageName = monitor_title + ':' + document.title;
    s.channel = monitor_title;
    s.prop1 = monitor_title;
    s.prop2 = monitor_title + ':' + document.title;
    s.prop3 = monitor_title + ':' + document.title;
    s.prop4 = monitor_title + ':' + document.title;
}