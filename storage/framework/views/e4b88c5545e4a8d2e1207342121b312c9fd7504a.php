		...
		<div class="panel-body">
			<form action="/admin/sys/config" method="post">
				...
				<div class="form-group">
					...
					<input type="text" name="keywords" value="<?php echo e(config('web.keywords')); ?>" class="form-control" placeholder="友情连接" id="">
				</div>
				<div class="form-group">
					<label for="">description</label>
					<input type="text" name="description"  value="<?php echo e(config('web.description')); ?>" class="form-control" placeholder="数值越大越靠前" id="">
				</div>
				<div class="form-group">
					<label for="">统计</label>
