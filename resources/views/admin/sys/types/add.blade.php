...
<div class="col-md-10">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<a href="index.html" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> 分类广告页面</a>
		...
		<div class="panel-body">
			<form action="/admin/sys/types" method="post">
				...
				<div class="form-group">
					...
					<br>
					<input type="radio" name="type" id="" value="0" checked> 小图
					<input type="radio" name="type" id="" value="1"> 大图
				</div>
